...
public class EmailPasswordActivity extends Activity implements    View.OnClickListener  {
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (!task.isSuccessful()) {
                            Toast.makeText(EmailPasswordActivity.this, "auth failed",
    ...
    private void updateUI(FirebaseUser user) {
        ...
        if (user != null) {
            mStatusTextView.setText("emailpassword status fmt "  + user.getEmail());
            mDetailTextView.setText("firebase status fmt "+ user.getUid());

            findViewById(R.id.email_password_buttons).setVisibility(View.GONE);
            findViewById(R.id.email_password_fields).setVisibility(View.GONE);
            findViewById(R.id.sign_out_button).setVisibility(View.VISIBLE);
        } else {
            mStatusTextView.setText("signed ou");
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.email_create_account_button) {
            ...
            Intent ii=new Intent(getBaseContext(),Inscri.class);
            startActivity(ii);
